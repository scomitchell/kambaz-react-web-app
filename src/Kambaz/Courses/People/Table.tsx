            ...
            <Table striped>
                ...
                <tbody>
                    ...
                    <tr><td className="wd-full-name text-nowrap">
                        ...
                        <td className="wd-total-activity">10:24:32</td></tr>
                    <tr><td className="wd-full-name text-nowrap">
                        <FaUserCircle className="me-2 fs-1 text-secondary" />
                        <span className="wd-first-name">Bob</span>{" "}
                        <span className="wd-last-name">Dylan</span></td>
                    ...
                    <tr><td className="wd-full-name text-nowrap">
                        <FaUserCircle className="me-2 fs-1 text-secondary" />
                        <span className="wd-first-name">Rebecca</span>{" "}
                        ...
                        <td className="wd-total-activity">11:24:32</td></tr>
                </tbody>
            </Table>
        </div>);
}